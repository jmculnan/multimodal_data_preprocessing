# small set
IS10_small = ['pcm_loudness_sma', 'F0finEnv_sma', 'voicingFinalUnclipped_sma', 'jitterLocal_sma',
              'shimmerLocal_sma', 'pcm_loudness_sma_de', 'F0finEnv_sma_de',
              'voicingFinalUnclipped_sma_de', 'jitterLocal_sma_de', 'shimmerLocal_sma_de']

# IS10 FULL SET
IS10_all = ['pcm_loudness_sma', 'mfcc_sma[0]', 'mfcc_sma[1]', 'mfcc_sma[2]', 'mfcc_sma[3]',
...
# IS11 FULL SET
IS11_all = ['pcm_RMSenergy_sma','pcm_fftMag_mfcc_sma[1]','pcm_fftMag_mfcc_sma[2]','pcm_fftMag_mfcc_sma[3]',
...
# IS12 FULL SET
IS12_all = ['F0final_sma','voicingFinalUnclipped_sma','audspec_lengthL1norm_sma',
...
# IS13 FULL SET
IS13_all = ['F0final_sma','voicingFinalUnclipped_sma','jitterLocal_sma','jitterDDP_sma','shimmerLocal_sma',
...
# IS10 PLUS IS13
IS10plus13_all = ["pcm_loudness_sma","mfcc_sma[0]","mfcc_sma[1]_x","mfcc_sma[2]_x","mfcc_sma[3]_x",
